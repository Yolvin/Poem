//
//  TeaBarViewController.m
//  Poem
//
//  Created by wyzc on 16/12/14.
...
@interface TeaBarViewController ()<UIScrollViewDelegate>
...
@implementation TeaBarViewController
...
////            make.width.mas_equalTo(self.view.mas_width).offset(-200);
////            make.height.mas_equalTo(self.view.mas_height);
////            
////        }];
//        CGFloat left = SCREENWIDTH - 100;
//        CGAffineTransform transform = CGAffineTransformMakeTranslation(left, 0);
//        self.view.transform = transform;
//        UIWindow * window=[UIApplication sharedApplication].keyWindow;
//        leftMenu * leftView = [[[NSBundle mainBundle] loadNibNamed:@"leftMenu" owner:self options:nil]lastObject];
//        leftView.backgroundColor = [UIColor redColor];
//        leftView.frame = CGRectMake(0, 0, SCREENWIDTH-100, [UIScreen mainScreen].bounds.size.height);
