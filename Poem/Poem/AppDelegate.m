...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString * version = [defau valueForKey:@"APP_VERSION"];
    
    if ([version isEqualToString:nowVersion]) {
        self.window.rootViewController = [[TeaBarViewController alloc]init];
    }else{
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Poem"];
